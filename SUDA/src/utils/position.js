...
// 			}
// 			else {//其它环境下的定位
// 				// if (isAndroid) {  //如果是安卓且在app中时，使用百度定位不精准
// 				// console.log('----------百度定位----------')
// 				// try {
// 				// 	const getLocation = new BMap.Geolocation();
// 				// 	getLocation.getCurrentPosition(
// 				// 		(position) => {
// 				// 			console.log('百度定位信息bdPosition：', position)
...
// 				// 				resolve(cityData)
// 				// 			} else {
// 				// 				let defLlocation = setDefaultLocationData()
// 				// 				resolve(defLlocation)
// 				// 			}
// 				// 		},
// 				// 		{ enableHighAccuracy: true },
// 				// 		(err) => {
// 				// 			console.log('百度定位失败', err)
// 				// 			let defLlocation = setDefaultLocationData()
// 				// 			resolve(defLlocation)
// 				// 		},
// 				// 		{ provider: "baidu" }
...
// 				// 	console.log('----------腾讯定位----------')
// 				try {
// 					var geolocation = new window.qq.maps.Geolocation("3MGBZ-HGUE6-TO3SC-EZJQA-ZRTHT-IYFUF", "myapp")
// 					var showPosition = function (position) {
// 						console.log('txPosition：', position)
// 						if (position) {
// 							let cityData = {
